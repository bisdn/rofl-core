...
protected:
	 ...
	 */
	virtual void
	handle_features_request(cofctl *ctl, cofpacket_features_request *pack);
	 ...
	 */
	virtual void
	handle_get_config_request(cofctl *ctrl, cofpacket_get_config_request *pack);
...
protected:
	 ...
	 */
	virtual void
	handle_group_mod(cofctl *ctl, cofpacket_group_mod *pack);
	 ...
	 */
	virtual void
	handle_table_mod(cofctl *ctl, cofpacket_table_mod *pack);
	 ...
	 */
	virtual void
	handle_port_mod(cofctl *ctl, cofpacket_port_mod *pack);
	 ...
	 */
	virtual void
	flow_mod_add(cofctl *ctl, cofpacket_flow_mod *pack, cfttable *ftable, cftentry *fte) {};
	 ...
	 */
	virtual void
	flow_mod_modify(cofctl *ctl, cofpacket_flow_mod *pack, cfttable *ftable, cftentry *fte) {};
	 ...
	 */
	virtual void
	flow_mod_delete(cofctl *ctl, cofpacket_flow_mod *pack) {};
	 ...
	 */
	virtual void
	group_mod_add(cofctl *ctl, cofpacket_group_mod *pack, cgtentry *gte) {};
	 ...
	 */
	virtual void
	group_mod_modify(cofctl *ctl, cofpacket_group_mod *pack, cgtentry *gte) {};
	 ...
	 */
	virtual void
	group_mod_delete(cofctl *ctl, cofpacket_group_mod *pack, cgtentry *gte) {};
