...
typedef struct of12_matching_algorithm_functions{
	...
	* the appropiate of12_destroy_flow_entry_with_reason() function. The matching algorithm does
	...
	* addition must behave exactly as defined in the of12_add_flow_entry_to_table() 
	*
	* The matching algorithm may use internally a different representation of the flow
	* entry, but it MUST always maintain the reference to the of12_flow_entry instance, 
	* and call appropiately of12_destroy_flow_entry_with_reason() or of12_update_flow_entry(). 
	* 
	...
	* modification must behave exactly as defined in the of12_modify_flow_entry_table() 
	*
	* The matching algorithm may use internally a different representation of the flow
	* entry, but it MUST always maintain the reference to the of12_flow_entry instance(s), 
	* and call appropiately of12_destroy_flow_entry_with_reason() or of12_update_flow_entry(). 
	* 
	* The matching algorithm shall use of12_update_flow_entry() when a modification must
	...
	* remvoal must behave exactly as defined in the of12_remove_flow_entry_table() 
	*
	* The matching algorithm may use internally a different representation of the flow
	* entry, but it MUST always maintain the reference to the of12_flow_entry instance(s), 
	* and call appropiately of12_destroy_flow_entry_with_reason().
	* 
	* The matching algorithm shall use of12_destroy_flow_entry_with_reason() when deletion must
	* take place, regardless of the internal representation it is using.
	*
	* The matching algorithm does NOT need to care about statistics or timers. 
	*
	...
	*
	* The matching algorithm may use of12_apply_actions_has() and of12_write_actions_has()
