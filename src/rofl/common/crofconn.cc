...
{
	LOGGING_DEBUG2 << "[rofl-common][crofconn] init thread" << std::endl;
	if (NULL == rofsock) {
		LOGGING_DEBUG2 << "[rofl-common][crofconn] creating new crofsock instance" << std::endl;
...
{
	LOGGING_DEBUG2 << "[rofl-common][crofconn] release thread" << std::endl;
	if (NULL != rofsock) {
		LOGGING_DEBUG2 << "[rofl-common][crofconn] destroying crofsock instance" << std::endl;
...
{
	LOGGING_DEBUG2 << "[rofl-common][crofconn] "
