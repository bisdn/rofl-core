...
private:
	...
	static int const CROFCONN_RECONNECT_START_TIMEOUT_IN_NSECS = 10000000;				// start reconnect timeout (default 1s)
	static int const CROFCONN_RECONNECT_VARIANCE_IN_NSECS = 10000000;
