...
class eHelloBase					: public eRofBase {};
...
class eBadRequestBase				: public eRofBase {};
...
class eBadActionBase				: public eRofBase {};
...
/* exceptions for action-containing requests according to OpenFlow */
class eBadInstBase					: public eRofBase {};
...
class eGroupModBase					: public eRofBase {};
...
class ePortModBase					: public eRofBase {};
...
class eTableModBase					: public eRofBase {};
...
class eQueueOpBase					: public eRofBase {};
...
class eSwitchConfigBase				: public eRofBase {};
...
class eRoleRequestBase				: public eRofBase {};
