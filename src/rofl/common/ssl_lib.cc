...
rofl::ssl_context::ssl_context(enum ssl_type type) :
		type(type) {
...
rofl::ssl_context* rofl::ssl_lib::create_ssl_context(enum ssl_context::ssl_type type) {
	return new ssl_context(type);
}
