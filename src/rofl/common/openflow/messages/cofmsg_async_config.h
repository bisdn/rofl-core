...
public:
	...
	cofmsg_async_config(
			uint8_t of_version = 0,
			uint8_t  type = OFPT_GET_ASYNC_REPLY,
			uint32_t xid = 0,
	 ...
	 *
	 */
	cofmsg_async_config(cmemory *memarea);
...
typedef cofmsg_async_config cofmsg_get_async_config_reply;
typedef cofmsg_async_config cofmsg_set_async_config;
