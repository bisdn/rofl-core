...
#define HAS_MASK_FLAG (1 << 8)
	...
	enum oxm_tlv_match_fields {
		OXM_TLV_BASIC_IN_PORT 		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IN_PORT << 9) 	|  8,	/* Switch input port. */				// required
		OXM_TLV_BASIC_IN_PHY_PORT 	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IN_PHY_PORT << 9) |  8, 	/* Switch physical input port. */
		OXM_TLV_BASIC_METADATA		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_METADATA << 9) 	| 12,	/* Metadata passed between tables. */
		OXM_TLV_BASIC_METADATA_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_METADATA << 9) 	| 20 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_ETH_DST		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_DST << 9) 	| 10,	/* Ethernet destination address. */		// required
		OXM_TLV_BASIC_ETH_DST_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_DST << 9) 	| 16 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_ETH_SRC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_SRC << 9) 	| 10,	/* Ethernet source address. */			// required
		OXM_TLV_BASIC_ETH_SRC_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_SRC << 9) 	| 16 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_ETH_TYPE		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_TYPE << 9) 	|  6,	/* Ethernet frame type. */				// required
		OXM_TLV_BASIC_VLAN_VID		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_VLAN_VID << 9)	|  6,	/* VLAN id. */
		OXM_TLV_BASIC_VLAN_VID_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_VLAN_VID << 9)	|  8 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_VLAN_PCP		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_VLAN_PCP << 9)	|  5,	/* VLAN priority. */
		OXM_TLV_BASIC_IP_DSCP		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IP_DSCP << 9) 	|  5,	/* IP DSCP (6 bits in ToS field). */
		OXM_TLV_BASIC_IP_ECN		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IP_ECN << 9)		|  5,	/* IP ECN (2 bits in ToS field). */
		OXM_TLV_BASIC_IP_PROTO		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IP_PROTO << 9)	|  5,	/* IP protocol. */						// required
		OXM_TLV_BASIC_IPV4_SRC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV4_SRC << 9)	|  8,	/* IPv4 source address. */				// required
		OXM_TLV_BASIC_IPV4_SRC_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV4_SRC << 9)	| 12 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_IPV4_DST		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV4_DST << 9)	|  8,	/* IPv4 destination address. */			// required
		OXM_TLV_BASIC_IPV4_DST_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV4_DST << 9)	| 12 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_TCP_SRC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_TCP_SRC << 9)		|  6,	/* TCP source port. */					// required
		OXM_TLV_BASIC_TCP_DST		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_TCP_DST << 9)		|  6,	/* TCP destination port. */				// required
		OXM_TLV_BASIC_UDP_SRC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_UDP_SRC << 9)		|  6,	/* UDP source port. */					// required
		OXM_TLV_BASIC_UDP_DST		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_UDP_DST << 9)		|  6,	/* UDP destination port. */				// required
		OXM_TLV_BASIC_SCTP_SRC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_SCTP_SRC << 9)	|  6,	/* SCTP source port. */
		OXM_TLV_BASIC_SCTP_DST		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_SCTP_DST << 9)	|  6,	/* SCTP destination port. */
		OXM_TLV_BASIC_ICMPV4_TYPE	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ICMPV4_TYPE << 9) |  5,	/* ICMP type. */
		OXM_TLV_BASIC_ICMPV4_CODE	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ICMPV4_CODE << 9) |  5,	/* ICMP code. */
		OXM_TLV_BASIC_ARP_OP		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_OP << 9)		|  6,	/* ARP opcode. */
		OXM_TLV_BASIC_ARP_SPA		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_SPA << 9) 	|  8,	/* ARP source IPv4 address. */
		OXM_TLV_BASIC_ARP_SPA_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_SPA << 9) 	| 12 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_ARP_TPA		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_TPA << 9)		|  8,	/* ARP target IPv4 address. */
		OXM_TLV_BASIC_ARP_TPA_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_TPA << 9)		| 12 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_ARP_SHA		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_SHA << 9)		| 10,	/* ARP source hardware address. */
		OXM_TLV_BASIC_ARP_SHA_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_SHA << 9)		| 16 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_ARP_THA		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_THA << 9) 	| 10,	/* ARP target hardware address. */
		OXM_TLV_BASIC_ARP_THA_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ARP_THA << 9) 	| 16 | HAS_MASK_FLAG,
		OXM_TLV_BASIC_IPV6_SRC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_SRC << 9)	| 20,	/* IPv6 source address. */				// required
		OXM_TLV_BASIC_IPV6_SRC_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_SRC << 9)	| 36 | HAS_MASK_FLAG,
		...
		OXM_TLV_BASIC_IPV6_ND_SLL	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_ND_SLL << 9) | 10,	/* Source link-layer for ND. */
		OXM_TLV_BASIC_IPV6_ND_TLL	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_ND_TLL << 9) | 10,	/* Target link-layer for ND. */
		OXM_TLV_BASIC_MPLS_LABEL	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_MPLS_LABEL << 9)  |  8,	/* MPLS label. */
		OXM_TLV_BASIC_MPLS_TC		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_MPLS_TC << 9)		|  5,	/* MPLS TC. */
		OXM_TLV_BASIC_MPLS_BOS		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_MPLS_BOS << 9) 	|  5,	/* MPLS BoS bit. */
		OXM_TLV_BASIC_PBB_ISID		= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_PBB_ISID << 9)	|  7,	/* PBB I-SID. */
		OXM_TLV_BASIC_PBB_ISID_MASK	= (OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_PBB_ISID << 9)	| 10 | HAS_MASK_FLAG,
