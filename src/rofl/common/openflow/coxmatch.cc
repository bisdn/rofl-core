...
coxmatch::test()
{
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_IN_PORT: %s\n", in_port.c_str());

	coxmatch_ofb_in_phy_port in_phy_port(48);
	fprintf(stderr, "openflow::OFPXMT_OFB_IN_PHY_PORT: %s\n", in_phy_port.c_str());

	coxmatch_ofb_metadata metadata(0xffeeffeeaabbaabbULL);
	fprintf(stderr, "openflow::OFPXMT_OFB_METADATA: %s\n", metadata.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_ETH_DST: %s\n", eth_dst.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_ETH_SRC: %s\n", eth_src.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_ETH_TYPE: %s\n", eth_type.c_str());

	coxmatch_ofb_vlan_vid vlan_vid(coxmatch_ofb_vlan_vid::VLAN_TAG_MODE_NORMAL, 4095);
	fprintf(stderr, "openflow::OFPXMT_OFB_VLAN_VID: %s\n", vlan_vid.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_VLAN_PCP: %s\n", vlan_pcp.c_str());

	coxmatch_ofb_ip_dscp ip_dscp(5);
	fprintf(stderr, "openflow::OFPXMT_OFB_IP_DSCP: %s\n", ip_dscp.c_str());

	coxmatch_ofb_ip_ecn ip_ecn(3);
	fprintf(stderr, "openflow::OFPXMT_OFB_IP_ECN: %s\n", ip_ecn.c_str());

	coxmatch_ofb_ip_proto ip_proto(6);
	fprintf(stderr, "openflow::OFPXMT_OFB_IP_PROTO: %s\n", ip_proto.c_str());

	coxmatch_ofb_ipv4_src ipv4_src(caddress(AF_INET, "1.1.1.1"));
	fprintf(stderr, "openflow::OFPXMT_OFB_IPV4_SRC: %s\n", ipv4_src.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_ARP_THA: %s\n", arp_tha.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_IPV6_SRC: %s\n", ipv6_src.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_IPV6_DST: %s\n", ipv6_dst.c_str());
	...
	fprintf(stderr, "openflow::OFPXMT_OFB_IPV6_FLABEL: %s\n", ipv6_flabel.c_str());

	coxmatch_ofb_ipv6_flabel ipv6_flabel_mask(3333, 6666);
	fprintf(stderr, "openflow::OFPXMT_OFB_IPV6_FLABEL: %s\n", ipv6_flabel_mask.c_str());

	coxmatch_ofb_icmpv6_type icmpv6_type(1);
	fprintf(stderr, "openflow::OFPXMT_OFB_ICMPV6_TYPE: %s\n", icmpv6_type.c_str());

	coxmatch_ofb_icmpv6_code icmpv6_code(1);
	fprintf(stderr, "openflow::OFPXMT_OFB_ICMPV6_CODE: %s\n", icmpv6_code.c_str());

	coxmatch_ofb_mpls_label mpls_label(0x555);
	fprintf(stderr, "openflow::OFPXMT_OFB_MPLS_LABEL: %s\n", mpls_label.c_str());

	coxmatch_ofb_mpls_tc mpls_tc(7);
	fprintf(stderr, "openflow::OFPXMT_OFB_MPLS_TC: %s\n", mpls_tc.c_str());
#endif
}
#endif
