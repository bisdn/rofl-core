...
ofperftest::request_flow_stats()
{
	...
	for (it = fib.begin(); it != fib.end(); ++it) {
		...
		fprintf(stderr, "ofperftest: calling FLOW-STATS-REQUEST for dpid: 0x%"PRIu64"\n",
				dpt->get_dpid());
...
void
ofperftest::handle_flow_stats_reply(cofdpt *dpt, cofmsg_flow_stats_reply *msg)
{
