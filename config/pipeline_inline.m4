...
echo "/* This Source Code Form is subject to the terms of the Mozilla Public" >> $ROFL_PIPELINE_CONFIG
echo " * License, v. 2.0. If a copy of the MPL was not distributed with this" >> $ROFL_PIPELINE_CONFIG
echo " * file, You can obtain one at http://mozilla.org/MPL/2.0/. */" >> $ROFL_PIPELINE_CONFIG
echo "" >> $ROFL_PIPELINE_CONFIG

#Disclaimer
echo "" >> $ROFL_PIPELINE_CONFIG
echo "//This file has been autogenerated at configure time. DO NOT MODIFY IT." >> $ROFL_PIPELINE_CONFIG
echo "" >> $ROFL_PIPELINE_CONFIG
echo "" >> $ROFL_PIPELINE_CONFIG
...
#End of file
echo "" >> $ROFL_PIPELINE_CONFIG
echo "#endif //__ROFL_PIPELINE_H__" >> $ROFL_PIPELINE_CONFIG
